...
COMPILATION ( for BlackBerry 10 NDK)
======================================

Install BlackBerry 10 NDK:

Run the BlackBerry 10 NDK Environment Settings script:

Windows:
> <BlackBerry NDK DIR>/bbndk-env.bat

Limux/Mac:
$ source <BlackBerry NDK DIR>/bbnk-env.sh

You need CMake (http://www.cmake.org). In a console, type:
cd build
cmake .. -DCMAKE_TOOLCHAIN_FILE="../CMake/toolchain/qnx.toolchain.cmake" -DCMAKE_INSTALL_PREFIX="../../BlackBerryDependencies"
make
make install
